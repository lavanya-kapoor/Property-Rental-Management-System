prompt --application/shared_components/user_interface/lovs/tenant_firstname
begin
--   Manifest
--     TENANT.FIRSTNAME
--   Manifest End
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(159005687479113466192)
,p_lov_name=>'TENANT.FIRSTNAME'
,p_static_id=>'tenant-firstname'
,p_source_type=>'TABLE'
,p_location=>'LOCAL'
,p_query_table=>'TENANT'
,p_return_column_name=>'TENANTID'
,p_display_column_name=>'FIRSTNAME'
,p_default_sort_column_name=>'FIRSTNAME'
,p_default_sort_direction=>'ASC'
,p_version_scn=>'15758026205647'
